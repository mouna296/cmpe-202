		...
		return cinemasList.length ? (
			cinemasList.map((cinema, index) => {
				return cinemas[selectedCinemaIndex]?._id === cinema._id ? (
					<button
						className="w-fit rounded-md bg-gradient-to-br from-red-600 to-red-700 px-2.5 py-1.5 text-lg font-medium text-white drop-shadow-xl hover:from-red-700 hover:to-red-600"
						onClick={() => {
					...
					<button
						className="w-fit rounded-md bg-gradient-to-br from-red-600 to-red-700 px-2 py-1 font-medium text-white drop-shadow-md hover:from-red-700 hover:to-red-600"
						onClick={() => {
				...
				>
					...
					{auth.role === 'admin' && (
						<div className="flex w-fit grow sm:justify-end">
							...
							<button
								disabled={isAdding}
								className="flex items-center whitespace-nowrap rounded-r-md bg-gradient-to-r from-lime-400 to-lime-600 px-2 py-1 font-medium text-white hover:from-lime-300 hover:to-lime-500 disabled:from-lime-500 disabled:to-lime-500"
							>
